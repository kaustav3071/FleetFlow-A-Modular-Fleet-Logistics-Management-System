    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Maintenance Details" size="md">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-surface-900 capitalize">{serviceLabel}</h3>
        ...
        {record.description && (
          <div className="p-3 rounded-xl bg-surface-50">
            ...
            <p className="text-sm text-surface-700">{record.description}</p>
          </div>
        )}
        {record.notes && (
          <div className="p-3 rounded-xl bg-surface-50">
            ...
            <p className="text-sm text-surface-700">{record.notes}</p>
          </div>
        )}
      </div>
    </Modal>
